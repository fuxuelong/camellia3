...
import com.qk.ginkgoservice.common.utils.PropertiesLoader;
...
public class Global {
     ...
     * 属性文件加载对象
     */
    private static PropertiesLoader loader = new PropertiesLoader("ginkgoapp-server.yml");
     ...
     * 获取homeSite
     */
    public static String getHomeSite() {
        return getConfig("homeSite");
    }
